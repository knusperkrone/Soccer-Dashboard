...
public class Collection_End extends OPTA_Event
{

    public Collection_End(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
    ...
    public int getID()
    {
        return API_TYPE_IDS.COLLECTION_END;
    }

    @Override
    public void calcRankingPoint(OPTA_Player player)
    {
        int value = (outcome) ? 0 : 0;
