...
public class Official_Change extends OPTA_Event
{

    public Official_Change(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
