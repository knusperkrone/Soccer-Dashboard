...
public class Smother extends OPTA_Event
{

    public Smother(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
