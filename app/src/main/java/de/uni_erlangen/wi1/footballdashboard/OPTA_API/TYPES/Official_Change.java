...
public class Official_Change extends OPTA_Type
{

    public Official_Change(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
