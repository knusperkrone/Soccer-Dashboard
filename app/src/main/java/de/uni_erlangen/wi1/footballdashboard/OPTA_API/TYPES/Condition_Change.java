...
public class Condition_Change extends OPTA_Type
{

    public Condition_Change(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
