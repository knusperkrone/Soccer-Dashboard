...
public class Player_Becomes_Goalkeeper extends OPTA_Type
{

    public Player_Becomes_Goalkeeper(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
