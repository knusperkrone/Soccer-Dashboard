...
public class Shield_Ball_OOP extends OPTA_Type
{

    public Shield_Ball_OOP(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
