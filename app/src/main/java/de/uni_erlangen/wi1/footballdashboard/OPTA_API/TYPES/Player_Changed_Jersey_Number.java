...
public class Player_Changed_Jersey_Number extends OPTA_Type
{

    public Player_Changed_Jersey_Number(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
