...
public class Player_Changed_Position extends OPTA_Type
{

    public Player_Changed_Position(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
