...
public class Keeper_Pick_Up extends OPTA_Event
{

    public Keeper_Pick_Up(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
