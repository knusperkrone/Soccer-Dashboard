...
public class Goalkeeper_Becomes_Player extends OPTA_Event
{

    public Goalkeeper_Becomes_Player(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
