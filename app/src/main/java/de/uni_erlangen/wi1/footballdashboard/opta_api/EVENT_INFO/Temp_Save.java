...
public class Temp_Save extends OPTA_Event
{

    public Temp_Save(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
