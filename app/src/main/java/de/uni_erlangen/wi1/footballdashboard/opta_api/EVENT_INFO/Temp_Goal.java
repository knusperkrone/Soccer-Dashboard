...
public class Temp_Goal extends OPTA_Event
{

    public Temp_Goal(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
