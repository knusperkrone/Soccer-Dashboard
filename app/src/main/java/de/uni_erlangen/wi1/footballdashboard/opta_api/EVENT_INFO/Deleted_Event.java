...
public class Deleted_Event extends OPTA_Event
{

    public Deleted_Event(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
