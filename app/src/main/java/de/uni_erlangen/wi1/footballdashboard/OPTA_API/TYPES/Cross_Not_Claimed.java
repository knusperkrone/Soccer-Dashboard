...
public class Cross_Not_Claimed extends OPTA_Type
{

    public Cross_Not_Claimed(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
