...
public class Player_Becomes_Goalkeeper extends OPTA_Event
{

    public Player_Becomes_Goalkeeper(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
    ...
    {
        return gov.getPlayerName(playerId, teamId) + " replaced the goalkeeper";
    }
