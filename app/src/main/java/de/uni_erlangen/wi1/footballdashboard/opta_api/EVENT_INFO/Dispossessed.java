...
public class Dispossessed extends OPTA_Event
{

    public Dispossessed(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
