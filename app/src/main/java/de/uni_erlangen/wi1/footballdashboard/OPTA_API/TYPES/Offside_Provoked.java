...
public class Offside_Provoked extends OPTA_Type
{

    public Offside_Provoked(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, int x, int y)
    {
