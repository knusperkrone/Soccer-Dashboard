...
public class Player_Returns extends OPTA_Event
{

    public Player_Returns(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
