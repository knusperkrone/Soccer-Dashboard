...
public class Punch extends OPTA_Event
{

    public Punch(boolean outcome, int period_id, int min, int sec, int playerId, int teamId, double x, double y)
    {
