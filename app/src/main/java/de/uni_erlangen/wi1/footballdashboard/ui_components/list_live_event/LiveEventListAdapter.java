...
public class LiveEventListAdapter extends ExpandableRecyclerAdapter<OPTA_Event, OPTA_Qualifier, LiveEventListAdapter.ViewHolderEvent, LiveEventListAdapter.ViewHolderQualifier>
{
    ...
    private final LiveFilter filter;

    public LiveEventListAdapter(@NonNull List<OPTA_Event> parentList, Context context,
                                RecyclerView parent, @NonNull LiveFilter filter)
    {
        super(parentList);
        this.parent = parent;
        this.filter = filter;
